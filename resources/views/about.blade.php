...
@section('seo')
    ...
    <meta property="og:title" content="Sobre Nosotros - Sodesa Soluciones y Deesarrollos S.A"/>
...
@section('content')
    ...
    <section
        ...
        data-src="{{ asset('img/bg-about.webp') }}">
                ...
                <div class="col-lg-6 cs_mb_lg_55">
                    <div class="cs_experience cs_style_1 position-relative">
                        <div class="cs_experience_thumb">
                            <img src="{{ asset('img/bg-about-1.webp') }}" alt="Thumb"
                        ...
                        <div
                            ...
                            data-src="{{ asset('img/bg-about-2.webp') }}">
    ...
    <section class="bg-brand-100 cs_pt_140 cs_pt_lg_80 cs_pb_140">
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-3 col-md-6">
                    <div
                        ...
                        <div class="cs_service_thumb position-relative cs_rounded_5">
                            ...
                            <div class="cs_service_thumb-in position-relative-in background-filled h-100"
                                 data-src="{{ asset('img/12.webp') }}"></div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-md-6">
